...
//    [self.view addSubview:lineView];
    ...
    NSLog(@"before frame:%@",NSStringFromCGRect(layer.frame));
    NSLog(@"before frame1:%@",NSStringFromCGRect(self.view.frame));
    layer.position = CGPointMake(50, 50);
    NSLog(@"after frame:%@",NSStringFromCGRect(layer.frame));
    NSLog(@"after frame1:%@",NSStringFromCGRect(self.view.frame));
    //设置颜色
